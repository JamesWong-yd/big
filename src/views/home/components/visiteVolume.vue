    ...
    mounted () {
        this.$nextTick(() => {
            ...
            const option = {
                ...
                yAxis: {
                    type: 'category',
                    data: ["南沙区","增城区","越秀区","花都区","白云区", "番禺区", "黄埔区", "萝岗区", "海珠区", "越秀区", "天河区"],
                    nameTextStyle: {
                        color: '#c3c3c3'
                    }
                },
                series: [
                    {
                        ...
                        type: 'bar',
                        data: [
                            {value: 142456, name: 'Sun', itemStyle: {normal: {color: '#2d8cf0'}}},
                            {value: 163456, name: 'Sun', itemStyle: {normal: {color: '#2d8cf0'}}},
                            {value: 153456, name: 'Sun', itemStyle: {normal: {color: '#2d8cf0'}}},
                            {value: 134556, name: 'Sun', itemStyle: {normal: {color: '#2d8cf0'}}},
                            {value: 543250, name: 'Fri', itemStyle: {normal: {color: '#2d8cf0'}}},
                            {value: 1305923, name: 'Sat', itemStyle: {normal: {color: '#2d8cf0'}}},
                            {value: 112136, name: 'Sun', itemStyle: {normal: {color: '#2d8cf0'}}},
